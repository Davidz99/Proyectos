...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-10-2018 a las 02:46:46
...
-- Base de datos: `saja`
--
CREATE DATABASE IF NOT EXISTS `saja` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `saja`;
...
--
-- Estructura de tabla para la tabla `observatorio_estudiantil`
--

CREATE TABLE `observatorio_estudiantil` (
...
('165', 'ADMINISTRADOR', 'DAVID', 'MURCIA', '2018-10-05 19:38:54', 'ACTIVO', 'DAVID', '123');
...
--
-- Indices de la tabla `observatorio_estudiantil`
--
ALTER TABLE `observatorio_estudiantil`
...
--
ALTER TABLE `año_escolar`
  MODIFY `IdAño` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `observatorio_estudiantil`
--
ALTER TABLE `observatorio_estudiantil`
  MODIFY `IdObservatorio` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `observatorio_estudiantil`
--
ALTER TABLE `observatorio_estudiantil`
  ADD CONSTRAINT `observatorio_estudiantil_ibfk_1` FOREIGN KEY (`IdEstudiante`) REFERENCES `estudiantes` (`IdEstudiante`) ON UPDATE CASCADE;
